...
import Lab1 from './Labs/Lab1/index';  // ✅ 确保路径正确
import Lab2 from './Labs/Lab2/index';  // ✅ 确保路径正确
    ...
    <Router>
      <div className="App">
        ...
        <Routes>
          ...
          <Route path="/labs/lab1" element={<Lab1 />} />  {/* ✅ 路径小写 */}
          <Route path="/labs/lab2" element={<Lab2 />} />  {/* ✅ 路径小写 */}
